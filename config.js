...
// 然後把下面的值換成你自己的。
window.APP_CONFIG = {
  FIREBASE_API_KEY: 'AIzaSyA6T_vyCmrT2kZrWl0U45xldVBHXfTKuLI',
  ...
  // 推播提醒用的 Cloudflare Worker 網址(也用來即時通知「有人新增/修改行程」)
  WORKER_URL: 'https://paixiaqu-reminder-worker.kuo-butler.workers.dev',
};
